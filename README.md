...
This project centers on CVE-2021-1675 + CVE-2021-34527, also known as the original zero-day exploit "PrintNightmare". There have been subsequent exploits related to this but we have a focus just on CVE-2021-1675 more than CVE-2021-34527.

# Background
What even is "PrintNightmare"? <br />
PrintNightmare is the name given to CVE-2021-1675 and cve-2021-34527, which is a privilige escalation vulnerability found on Windows environments in the print spooler service(1675) and 34527RCE(remoteCodeExecution). This service is enabled by default on all client and server platforms. Microsoft delayed issuing a patch for the vulneraility for nearly 10 days after it was made public because the CVSS was originally deemed low then was escalated to critical (9.3). <br />
